...
export const CommonStripes: React.FC<TeamDecorationProps> = ({
  ...
  // 색상 우선순위: color prop > teamColors.repeatedStripesColor > teamColors.decorationBorder > teamData.mainColor > 기본값
  const stripeColor = color || teamColors?.repeatedStripesColor || teamColors?.decorationBorder || teamData?.mainColor || '#D9D9D9';
